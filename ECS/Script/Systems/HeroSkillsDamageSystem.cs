...
namespace BlackDawn.DOTS
{
    ...
    /// </summary>
    [BurstCompile]
    struct ApplySkillDamageJob : IJobFor
    {
        ...
        static readonly ProfilerMarker mP_Execute =
new ProfilerMarker("SkillDamageJob.Execute");

        public void Execute(int i)
        {
            using (mP_Execute.Auto())
            {
                ...
                // DevDebug.Log($"[SkillHit] idx={i}, target={target.Index}, fire={d.fireDamage:F2}, fireDOT={d.fireDotDamage:F2}, slow={d.tempSlow:F2},长度={HitArray.Length}");
