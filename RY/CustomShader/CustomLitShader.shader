Shader "Universal Render Pipeline/CustomLit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Scripts/RY/CustomShader/LitInput.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/Scripts/RY/CustomShader/ShadowCasterPassChange.hlsl"
            ENDHLSL
        }
        ...
        //=============================
        // add.1) Outline Pass（描边效果）
        //=============================
        Pass
        {
            Name "CustomOutline"
            // 将该 Pass 放到 Transparent 队列中，确保它后渲染
            Tags { "LightMode" = "CustomPassOutline"}
            // 并关闭深度写入（ZWrite Off）与启用透明混合
            Cull Front
            ZWrite On
            ZTest Less
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.CustomLitShaderGUI"
}
